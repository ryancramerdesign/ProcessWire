...
CREATE INDEX IF NOT EXISTS field_body_data ON field_body(data);
...
CREATE INDEX IF NOT EXISTS field_headline_data ON field_headline(data);
...
CREATE INDEX IF NOT EXISTS field_images_data ON field_images(data);
CREATE INDEX IF NOT EXISTS field_images_description ON field_images(description);
...
CREATE INDEX IF NOT EXISTS field_sidebar_data ON field_sidebar(data);
...
CREATE INDEX IF NOT EXISTS field_summary_data ON field_summary(data);
