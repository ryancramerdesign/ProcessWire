...
CREATE TABLE IF NOT EXISTS field_email (
  pages_id INTEGER PRIMARY KEY NOT NULL,
  "data" TEXT NOT NULL DEFAULT ''
 );

CREATE INDEX IF NOT EXISTS field_email_data ON field_email(data);
...
CREATE INDEX IF NOT EXISTS field_pass_data ON field_pass(data);
...
CREATE INDEX IF NOT EXISTS field_permissions_data ON field_permissions(data,pages_id,sort);
...
CREATE INDEX IF NOT EXISTS field_process_data ON field_process(data);
...
CREATE INDEX IF NOT EXISTS field_roles_data ON field_roles(data,pages_id,sort);
...
CREATE INDEX IF NOT EXISTS field_title_data ON field_title(data);
...
CREATE TABLE IF NOT EXISTS templates (
  ...
  fieldgroups_id INTEGER NOT NULL DEFAULT 0,
  flags int(11) NOT NULL DEFAULT 0,
  cache_time mediumint(9) NOT NULL DEFAULT 0,
  data text NOT NULL
);

CREATE INDEX IF NOT EXISTS templates_fieldgroups_id ON templates(fieldgroups_id);
...
CREATE TABLE IF NOT EXISTS fieldgroups_fields (
  fieldgroups_id INTEGER NOT NULL DEFAULT 0,
  fields_id INTEGER NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS fields_type ON fields(type);
...
CREATE TABLE IF NOT EXISTS modules (
 id INTEGER PRIMARY KEY  AUTOINCREMENT NOT NULL,
  class varchar(128) UNIQUE NOT NULL,
  flags int(11) NOT NULL DEFAULT 0,
  data text NOT NULL
);
...
CREATE TABLE IF NOT EXISTS pages (
  ...
  templates_id INTEGER NOT NULL DEFAULT 0,
  name varchar(128) NOT NULL,
  status INTEGER NOT NULL DEFAULT 1,
  modified timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  modified_users_id INTEGER NOT NULL DEFAULT 2,
  created timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  created_users_id INTEGER NOT NULL DEFAULT 2,
  sort int(11) NOT NULL DEFAULT 0
) ;

CREATE UNIQUE INDEX IF NOT EXISTS pages_name_parent_id ON pages(name,parent_id);
CREATE INDEX IF NOT EXISTS pages_parent ON pages(parent_id);
CREATE INDEX IF NOT EXISTS pages_templates ON pages(templates_id);
CREATE INDEX IF NOT EXISTS pages_modified ON pages(modified);
CREATE INDEX IF NOT EXISTS pages_created ON pages(created);
...
CREATE INDEX IF NOT EXISTS pages_access_templates_id ON pages_access(templates_id);
...
CREATE TABLE IF NOT EXISTS pages_sortfields (
  pages_id INTEGER NOT NULL DEFAULT 0,
