(function() {
	...
	CKEDITOR.plugins.add('pwimage', {
		...
		init: function(editor) {
			...
			// It should clean all other classes but three align classes that are generated by ProcessWire
			var allowed = 'img[alt,id,!src,title]{class}(align_left,align_center,align_right,hidpi,align-left,align-center,align-right);a[!href]';
				...
				$iframe.dialog("option", "buttons", [
					{ 
						...
						click:  function() {
							...
							var hidpi = $("#selected_image_hidpi").length > 0 ? 1 : 0;
