(function() {
	...
	function loadIframeLinkPicker(editor) {
		...
		$iframe.load(function() {
			...
			if(title && title.length) $i.find("#link_page_title").val(title);
		});
